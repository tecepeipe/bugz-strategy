...
import type { AxialHex, BoardState, ExpansionsConfig, Piece, Player } from '../types/bugz';
import { hexKey } from '../types/bugz';
import { computeAIMove } from './bugzAI';
...
test('AI is forced to place its queen on its 3rd turn for all difficulties', () => {
